...
(function () {
    ...
    /**
     * 監聽確認和取消兩個按鈕事件，使用者執行插入或者清空正在播放的視頻實例操作
     */
    ...
    function insertUpload() {
        ...
        if (count) {
            $('.info', '#queueList').html('<span style="color:red;">' + '還有2個未上傳檔'.replace(/[\d]/, count) + '</span>');
            return false;
        } else {
